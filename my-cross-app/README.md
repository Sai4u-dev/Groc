...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/2ndqxmwcJk)
...
```sh
npx nx serve my-cross-app
```

To create a production bundle:

```sh
npx nx build my-cross-app
```

To see all available targets to run for a project, run:

```sh
npx nx show project my-cross-app
```
